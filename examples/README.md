...
This example demonstrates how to use the `mcp-lambda-sdk` package to create a Model Context Protocol server that runs on AWS Lambda.
...
```typescript
import { z, MCPServer, MCPTool, MCPSessionManager } from 'mcp-lambda-sdk';
